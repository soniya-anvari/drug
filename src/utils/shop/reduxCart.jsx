...
import getTotalPrice from "../../../src/helper/getTotalPrice";
import getCountOfProudcts from "../../../src/helper/getCountOfProudcts";
const initialState = {
    ...
    addToCart(state, action) {
      ...
      if (existingIndex >= 0) {
        state.cartItems[existingIndex] = {
          ...state.cartItems[existingIndex],
          cartQuantity:
            state.cartItems[existingIndex].cartQuantity + action.payload.count,
        };
